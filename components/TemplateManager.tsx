            ...
            <form onSubmit={handleAddSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[var(--theme-bg)]/80 border border-[var(--theme-border)] rounded-md p-3 text-[var(--theme-text-primary)] focus:ring-2 focus:ring-[var(--theme-yellow)] focus:border-[var(--theme-yellow)] transition-shadow duration-200 min-h-[200px] resize-y"
                  rows={8}
                />
              </div>
          ...
          <div className="pt-6">
            ...
            <ul className="space-y-3">
              {templates.map(template => (
                <li key={template.id} className="bg-[var(--theme-bg)]/50 p-3 rounded-md flex items-center justify-between">
                  {editingId === template.id ? (
                    <div className="flex-grow flex items-center gap-2">
                      <input
                        ...
                        className="w-full bg-[var(--theme-card-bg)] border border-[var(--theme-border)] rounded-md py-1 px-2 text-[var(--theme-text-primary)] focus:ring-1 focus:ring-[var(--theme-yellow)] focus:border-[var(--theme-yellow)]"
                        autoFocus
                      />
