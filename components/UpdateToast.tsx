...
export const UpdateToast: React.FC<UpdateToastProps> = ({ onUpdate }) => {
  return (
    <div
      className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 bg-[var(--theme-green)] text-black rounded-full shadow-2xl animate-fade-in-down flex items-center gap-4 px-5 py-3"
      role="alert"
      aria-live="assertive"
    >
      <DownloadIcon />
