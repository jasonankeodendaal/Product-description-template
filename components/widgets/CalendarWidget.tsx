...
export const CalendarWidget: React.FC<CalendarWidgetProps> = ({ onOpenCalendar, events }) => {
    ...
    return (
        <button 
            ...
            className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 h-full shadow-lg border border-white/10 flex flex-col w-full text-left transition-transform hover:scale-[1.02]"
        >
