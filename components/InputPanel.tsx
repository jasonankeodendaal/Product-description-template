  ...
  return (
    <div className="bg-[var(--theme-card-bg)] backdrop-blur-xl p-4 md:p-6 rounded-lg shadow-lg border border-[var(--theme-border)] flex flex-col flex-1">
      ...
      <button
        ...
        className="mt-4 self-end flex items-center justify-center gap-1.5 text-black font-semibold py-1.5 px-3 text-xs rounded-md hover:opacity-90 disabled:bg-[var(--theme-border)] disabled:text-[var(--theme-text-secondary)]/50 disabled:cursor-not-allowed transition-colors duration-200"
      >
        {isLoading ? (
          <>
