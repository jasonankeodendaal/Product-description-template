...
export const CameraCapture: React.FC<CameraCaptureProps> = ({ onCapture, onClose, mode = 'photo' }) => {
  ...
  const takePicture = useCallback(() => {
    ...
    // FIX: Replaced fragile `document.querySelector` with a robust `window.getComputedStyle` on the video element itself, which has the filter class applied. This also resolves the TypeScript error as `video` is an HTMLElement.
